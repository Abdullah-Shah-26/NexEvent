...
export default function EventForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formDataToSend.set("overview", formData.overview);
    formDataToSend.set("venue", formData.venue);
    formDataToSend.set("mode", formData.mode);
    formDataToSend.set("audience", formData.audience);
    formDataToSend.set("organizer", formData.organizer);
